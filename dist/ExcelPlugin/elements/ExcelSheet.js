...
var _ExcelColumn = _interopRequireDefault(require("./ExcelColumn"));
...
var ExcelSheet = /*#__PURE__*/function (_React$Component) {
...
_defineProperty(ExcelSheet, "propsTypes", {
  name: _propTypes.default.string.isRequired,
  data: _propTypes.default.arrayOf(_propTypes.default.object),
  dataSet: _propTypes.default.arrayOf(_propTypes.default.object),
  value: _propTypes.default.oneOfType([_propTypes.default.array, _propTypes.default.func]).isRequired,
  children: _propTypes.default.arrayOf(function (propValue, key) {
    var type = propValue[key];
    if (type !== _ExcelColumn.default) {
